...
Zusätzlich zur Terminal-Version existiert jetzt ein Web-Interface über Gradio, das den Chatbot in deinem Browser unter `http://localhost:7860` verfügbar macht.

### Zusätzliche Abhängigkeit installieren

In derselben Conda-/venv-Umgebung:
...
2.  **ui.py ausführen:**
    Im Hauptverzeichnis (SAI3-Chatbot):
